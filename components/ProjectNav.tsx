...
const projects: NavItem[] = [
  ...
  { year: "2022", name: "Futuro Farming", id: "futuro-farming" },
  { year: "2022", name: "Spotify Playlist Analyzer", id: "spotify-playlist-analyzer" },
  { year: "2022", name: "Solarkraft", id: "solarkraft" },
  { year: "2022", name: "Route Builder", id: "route-builder" },
  { year: "2021", name: "Data Lineage at BMW", id: "data-lineage" },
