...
I like doing this especially for green field apps where I have multiple features in mind. Using superwhisper, I explain all my feature requirements, the edge cases I can think of and how to test it. I also let Claude augment this and write it all into a PRD file.
Then you can start a ralph loop, which will just go ahead as long as it takes until the Requirements are met. This can take around an hour in my experience.

You can check out this [project](https://github.com/ASchwad/boxflow). It is a mix of powerpoint and excalidraw. I have not looked into the code once and this was a couple Ralph Loop iterations with manual testing in between. Magical experience.
