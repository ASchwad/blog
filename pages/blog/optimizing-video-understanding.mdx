...
When looking at coding, Google Gemini is usually far behind Anthropic and OpenAI. But the model has in my opinion the best out-of-the-box capabilities regarding multi-modality input: PDF, Image Analysis and foremost Video Understanding.
