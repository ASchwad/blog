...
So what am I even using Claude Code for at the moment? Still classic Fullstack Development tasks:
...
Where am I **not** using Claude Code?

- Only really in validating ideas and showing new features to customers. Still wondering how I could leverage it more here
...
- tools: You can specify exactly which tools you allow the subagent to use (`mcp**playwright**browser_navigate, mcp**playwright**browser_snapshot, mcp**playwright**browser_take_screenshot, mcp**playwright**browser_click, mcp**playwright**browser_resize, mcp**playwright**browser_hover, mcp**playwright**browser_close, Read, Glob`)
