...
Coming from a traditional coding background, letting go of line-by-line control felt (and still feels) weird. But in the bigger picture, code has always been a means to an end for me: building a working product that solves a problem. The implementation details are important, but secondary.
